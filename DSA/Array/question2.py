...
def candyDistribution(candyType):


    uniqueCandies = set(candyType)        #taking uniqe candy type
...
candy = list(map(int,input("Enter candy type : ").split()))

#printing result

print(candyDistribution(candy))
